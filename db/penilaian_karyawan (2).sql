...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Nov 2023 pada 13.15
...
(2, 'Keterlambatann', 'Costt', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tbl_hasil_rekomendasi`
  MODIFY `id_hasil_rekomedasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_nilai_alternatif`
  MODIFY `id_nilai_alternatif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_nilai_bobot`
--
ALTER TABLE `tbl_nilai_bobot`
  MODIFY `id_nilai_bobot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_nilai_normalisasi`
--
ALTER TABLE `tbl_nilai_normalisasi`
  MODIFY `id_nilai_normalisasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_nilai_perangkingan`
--
ALTER TABLE `tbl_nilai_perangkingan`
  MODIFY `id_nilai_perangkingan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_normalisasi_bobot`
--
ALTER TABLE `tbl_normalisasi_bobot`
  MODIFY `id_normalisasi_bobot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_vektor_s`
  MODIFY `id_vektor_s` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_vektor_v`
--
ALTER TABLE `tbl_vektor_v`
  MODIFY `id_vektor_v` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
