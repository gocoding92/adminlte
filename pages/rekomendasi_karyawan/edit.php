<html>
    <head>
        <meta charset="TTF-8"> 
        <title>Edit Rekomendasi Karyawan</title>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cars" id="cars" class="form-control">
                                            ...
                                            <?php while ($users = mysqli_fetch_array($query)){ ?>
                                                <option value="<?php echo $users['id_karyawan']?>"><?php echo $users['nama_lengkap']?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                   <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="periode_bulan" placeholder="masukkan bulan">
                                   </div>
                                </div>
                            </div>
