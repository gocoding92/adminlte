          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <div class="row mb-2">
                  <div class="col-lg-12">
                    <a href="create.php" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Master Jabatan </a>
                  </div>
                </div>
                <hr />
                <table id="list-data-table" class="table table-bordered table-striped">
                  ...
                  <?php
                    $no =1;
                    $sql ="SELECT * FROM tbl_jabatan WHERE deleted_at='0'";
                  ...
                  ?>
                    ...
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td>
                      <a href="edit.php?id=<?php echo $data['id_jabatan']; ?>">
                          <span class="right badge badge-info"><i class="fa fa-edit"></i>&nbsp; Edit</span>
                        </a>
                        <a href="controllers/delete.php?id=<?php echo $data['id_jabatan']; ?>">
