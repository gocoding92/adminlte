...
<head>
    ...
    <link rel="shortcut icon" href="https://www.akseleran.co.id/blog/wp-content/uploads/2022/10/download-1.png" type="image/x-icon">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>25/12/01</td>
                    <td>
                      <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#exampleModalEdit">Edit</button>
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleDetail">Detail</button>
