                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis_tanaman" id="" class="form-control">
                                                        ...
                                                        <?php while ($data_tanaman = mysqli_fetch_array($query_jenis_tanaman)) { ?>
                                                            <option value="<?php echo $data_tanaman['id_jenis_tanaman']; ?>" <?php echo $data_tanaman['id_jenis_tanaman'] == $data['id_jenis_tanaman'] ? 'selected' : null  ?>><?php echo $data_tanaman['jenis_tanaman']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis_penyakit" id="" class="form-control">
                                                        ...
                                                        <?php while ($data_penyakit = mysqli_fetch_array($query_jenis_penyakit)) { ?>
                                                            <option value="<?php echo $data_penyakit['id_jenis_penyakit']; ?>" <?php echo $data_penyakit['id_jenis_penyakit'] == $data['id_penyakit'] ? 'selected' : null  ?>><?php echo $data_penyakit['jenis_penyakit']; ?></option>
                                                        <?php } ?>
                                                    </select>
