              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit.php?id=<?php echo $user['id_jenis_barang']; ?>" class="btn btn-sm btn-primary">Edit</a>
                      <!-- <a href="detail.php?id=<?php echo $user['id_jenis_barang']; ?>" class="btn btn-sm btn-info">Detail</a> -->
                      <a href="controllers/delete.php?id=<?php echo $user['id_jenis_barang']; ?>" class="btn btn-sm btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php } ?>
                </table>
