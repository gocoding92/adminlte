                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kriteria" placeholder="masukkan kriteria">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Atribut</label>
                                            <input type="text" class="form-control" name="atribut" placeholder="masukkan atribut">
                                        </div>
                                    </div>
                                </div>
