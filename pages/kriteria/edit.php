        ...
        <div class="wrapper">
            ...
            <?php
                if (isset($_GET['id'])){
                    ...
                    $sql = "SELECT * FROM tbl_kriteria WHERE id_kriteria=$id ";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kriteria" placeholder="Masukkan Kriteria" value="<?php echo $kriteria['kriteria']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Atribut</label>
                                            <input type="text" class="form-control" name="atribut" placeholder="Masukkan Atribut" value="<?php echo $kriteria['atribut']; ?>">
                                        </div>
                                    </div>
                                </div>
