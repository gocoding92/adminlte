            ...
            <div class="card my-3">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     <?php                      
                     $query = mysqli_query($db, "SELECT * FROM data_rekrutmen WHERE delete_at = '0'");
                     $no = 1;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit.php?id=<?php echo $data['id_rekrutmen'];  ?>" class="btn btn-sm btn-info">Edit</a>
                      <a href="detail.php?id=<?php echo $data['id_user'];  ?>" class="btn btn-sm btn-primary">Detail</a>
                      <a href="controllers/delete.php?id=<?php echo $data['id_rekrutmen'];  ?>" class="btn btn-sm btn-danger">Delete</a>
                    </td>
                  </tr>
                   <?php } ?>
                </table>
